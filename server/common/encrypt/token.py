...
class JWT():
    ...
    def encode(self_payload, key=None):
        ...
        self_payload_copy_json_base64 = JWT.b64encode(self_payload_copy_json.encode("utf-8"))

        # init sign
        if isinstance(key, str):
            key = key.encode()
        hm = hmac.new(key, header_json_base64 + b'.' + self_payload_copy_json_base64,
...
if __name__ == '__main__':
    ...
    key = b"\x92\xcb\xe30\x83\xee\xcc,2\x10\xb9\x81\x03\xa7\xf1\x98\x18\xe5PF\xa7\x95\xad\x85'\xca\xc7\xb2O,|l"
    token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE2NTI4NjUzMTAuNzI4NjY1NiwibmFtZSI6Im5ieGxoYzgifQ.a9klp6KCs2NZvGS3L3qk46yn0fXKI43Xl8vifASzNIg"
    print(JWT.decode(token, key))  # 校验令牌 返回payload明文 字典类型
